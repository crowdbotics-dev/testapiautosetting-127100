...
## Project Structure
    ...
    ├── testapiautosetting_127100  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127100`
...
2. Clone this repo and `cd testapiautosetting_127100`
